...
const AE: Dict = {
  ...
  ko: {
    ...
    'ae.q7.v': '인텔 맥은 안 됩니다',
    'ae.q7.a': 'macOS 는 <b>Apple Silicon 에서만</b> 돕니다. Windows 에서는 그래픽카드로 계산하고, 안 되면 CPU 로 돕니다. 처음 쓸 때 약 110MB 를 한 번 내려받고, 그 뒤로는 바로 돕니다.',
    'ae.q8.q': '구독인가요?',
    'ae.q8.v': '아닙니다',
    ...
    'ae.sp4.k': '운영체제',
    'ae.sp4.v': 'Windows · macOS',
    'ae.sp4.n': 'Depth Pass 는 Apple Silicon Mac 과 Windows 에서 돕니다 — 인텔 Mac 은 안 됩니다',
    'ae.sp5.k': '라이선스',
    'ae.sp5.v': '컴퓨터 2대 · 1인',
